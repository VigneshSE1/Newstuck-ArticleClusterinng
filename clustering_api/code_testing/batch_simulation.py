# -*- coding: utf-8 -*-
"""
Created on Mon Dec 21 10:56:43 2020
...
keys = ['day1', 'day2', 'day3']
with open('en_title_results.json', 'w', encoding="utf8") as f:
    json.dump(dict.fromkeys(keys, [json.loads(x) for x in daywise_result]), f, ensure_ascii=False, indent=4)
